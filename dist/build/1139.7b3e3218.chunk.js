"use strict";(self.webpackChunktanis_cms=self.webpackChunktanis_cms||[]).push([[1139],{52447:(L,D,s)=>{s.d(D,{B:()=>U,D:()=>B,H:()=>y,R:()=>K});var t=s(92132),l=s(83997),d=s(30893),P=s(42455),O=s(38413),g=s(4198),m=s(55356),a=s(34372),e=s(9005),o=s(46270),E=s(54894),c=s(58896),h=s(25524),i=s(63891);const M=(0,i.default)(l.s)`
  svg path {
    fill: ${({theme:r})=>r.colors.neutral600};
  }
`,I=({name:r})=>(0,t.jsxs)(l.s,{background:"primary100",borderStyle:"dashed",borderColor:"primary600",borderWidth:"1px",gap:3,hasRadius:!0,padding:3,shadow:"tableShadow",width:(0,a.a8)(300),children:[(0,t.jsx)(M,{alignItems:"center",background:"neutral200",borderRadius:"50%",height:6,justifyContent:"center",width:6,children:(0,t.jsx)(e.A,{width:`${8/16}rem`})}),(0,t.jsx)(d.o,{fontWeight:"bold",children:r})]}),B=()=>(0,t.jsx)(c.P,{renderItem:r=>{if(r.type===h.D.STAGE)return(0,t.jsx)(I,{name:typeof r.item=="string"?r.item:null})}}),K=({children:r})=>(0,t.jsx)(P.P,{children:(0,t.jsx)(O.g,{tabIndex:-1,children:(0,t.jsx)(g.s,{children:r})})}),U=({href:r})=>{const{formatMessage:C}=(0,E.A)();return(0,t.jsx)(a.N_,{startIcon:(0,t.jsx)(o.A,{}),to:r,children:C({id:"global.back",defaultMessage:"Back"})})},y=({title:r,subtitle:C,navigationAction:W,primaryAction:T})=>(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(a.x7,{name:r}),(0,t.jsx)(m.Q,{navigationAction:W,primaryAction:T,title:r,subtitle:C})]})},51139:(L,D,s)=>{s.d(D,{ProtectedReviewWorkflowsPage:()=>X});var t=s(92132),l=s(21272),d=s(83997),P=s(43064),O=s(35513),g=s(40216),m=s(26127),a=s(90361),e=s(33363),o=s(30893),E=s(98765),c=s(25641),h=s(88353),i=s(34372),M=s(5194),I=s(41909),B=s(50612),K=s(54894),U=s(17703),y=s(63891),r=s(58896),C=s(22249),W=s(52447),T=s(45084),Q=s(25524),G=s(24272),ls=s(15126),Es=s(63299),ds=s(67014),Ms=s(59080),Ds=s(79275),Ps=s(14718),Os=s(82437),gs=s(76885),ms=s(5790),cs=s(12083),fs=s(35223),vs=s(5409),hs=s(74930),Cs=s(2600),Ts=s(48940),Ls=s(41286),Ws=s(56336),As=s(13426),Rs=s(84624),Is=s(77965),Bs=s(54257),Ks=s(71210),Us=s(51187),ys=s(39404),js=s(58692),us=s(501),xs=s(57646),ws=s(23120),ps=s(44414),Ss=s(25962),Ns=s(14664),$s=s(42588),Fs=s(90325),zs=s(62785),Hs=s(87443),Qs=s(41032),Gs=s(22957),Ys=s(93179),Vs=s(73055),Xs=s(15747),Zs=s(85306),ks=s(26509),Js=s(32058),bs=s(81185),qs=s(82261),st=s(42013);const Y=(0,y.default)(i.N_)`
  align-items: center;
  height: ${(0,i.a8)(32)};
  display: flex;
