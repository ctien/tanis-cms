...
`,C={common:_t,light:y,dark:d,additional:_},G=()=>{const f=localStorage.getItem("STRAPI_THEME")||"light",{theme:E,themeOverwrite:a}=globalThis.CKEditorConfig||{},r=a?E:{...C,...E};return(0,Y.createGlobalStyle)`
       ${r.common}
       ${r[f]}
       ${r.additional}
   `},z=({isOpen:f,onChange:E,onToggle:a,editor:r,uploadConfig:{responsiveDimensions:t}})=>{const{components:e}=(0,P.tF)(),o=e["media-library"],i=c=>{let n="";c.map(({name:b,url:v,alt:D,formats:K,mime:Z,width:Q,height:L})=>{if(Z.includes("image"))if(K&&t){let H="";Object.keys(K).sort((h,p)=>K[h].width-K[p].width).map(h=>H+=(0,P.vX)(K[h].url)+` ${K[h].width}w,`),n+=`<img src="${v}" alt="${D}" width="${Q}" height="${L}" srcset="${H}" />`}else n+=`<img src="${v}" alt="${D}" width="${Q}" height="${L}" />`;else Z.includes("application/pdf")?n=`<a href="${(0,P.vX)(v)}" download="${b}">${b||"Download PDF"}</a>`:Z.includes("video")&&(n=`
            <video class="video" controls width="500px">
                <source src="${(0,P.vX)(v)}" type="${Z}" />
            <video/>`)});const u=r.data.processor.toView(n),l=r.data.toModel(u);r.model.insertContent(l),a()},s=c=>{const n=c.map(u=>({name:u.name,alt:u.alternativeText||u.name,url:(0,P.vX)(u.url),mime:u.mime,formats:u.formats,width:u.width,height:u.height}));i(n)};return f?(0,A.jsx)(o,{onClose:a,onSelectAssets:s}):null};z.defaultProps={isOpen:!1,onChange:()=>{},onToggle:()=>{}},z.propTypes={isOpen:F().bool,onChange:F().func,onToggle:F().func};const ot=z;var tt=x(84316);/*!
 * @license Copyright (c) 2003-2024, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md.
 */(()=>{var f={662:(t,e,o)=>{"use strict";o.d(e,{A:()=>c});var i=o(935),s=o.n(i)()(function(n){return n[1]});s.push([t.id,".ck.ck-editor{position:relative}.ck.ck-editor .ck-editor__top .ck-sticky-panel .ck-toolbar{z-index:var(--ck-z-panel)}.ck.ck-editor__top .ck-sticky-panel .ck-sticky-panel__content{border-radius:0}.ck-rounded-corners .ck.ck-editor__top .ck-sticky-panel .ck-sticky-panel__content,.ck.ck-editor__top .ck-sticky-panel .ck-sticky-panel__content.ck-rounded-corners{border-radius:var(--ck-border-radius);border-bottom-left-radius:0;border-bottom-right-radius:0}.ck.ck-editor__top .ck-sticky-panel .ck-sticky-panel__content{border:solid var(--ck-color-base-border);border-width:1px 1px 0}.ck.ck-editor__top .ck-sticky-panel .ck-sticky-panel__content.ck-sticky-panel__content_sticky{border-bottom-width:1px}.ck.ck-editor__top .ck-sticky-panel .ck-sticky-panel__content .ck-menu-bar,.ck.ck-editor__top .ck-sticky-panel .ck-sticky-panel__content .ck-toolbar{border:0}.ck.ck-editor__main>.ck-editor__editable{background:var(--ck-color-base-background);border-radius:0}.ck-rounded-corners .ck.ck-editor__main>.ck-editor__editable,.ck.ck-editor__main>.ck-editor__editable.ck-rounded-corners{border-radius:var(--ck-border-radius);border-top-left-radius:0;border-top-right-radius:0}.ck.ck-editor__main>.ck-editor__editable:not(.ck-focused){border-color:var(--ck-color-base-border)}",""]);const c=s},935:t=>{"use strict";t.exports=function(e){var o=[];return o.toString=function(){return this.map(function(i){var s=e(i);return i[2]?"@media ".concat(i[2]," {").concat(s,"}"):s}).join("")},o.i=function(i,s,c){typeof i=="string"&&(i=[[null,i,""]]);var n={};if(c)for(var u=0;u<this.length;u++){var l=this[u][0];l!=null&&(n[l]=!0)}for(var b=0;b<i.length;b++){var v=[].concat(i[b]);c&&n[v[0]]||(s&&(v[2]?v[2]="".concat(s," and ").concat(v[2]):v[2]=s),o.push(v))}},o}},591:(t,e,o)=>{"use strict";var i,s=function(){return i===void 0&&(i=Boolean(window&&document&&document.all&&!window.atob)),i},c=function(){var g={};return function(h){if(g[h]===void 0){var p=document.querySelector(h);if(window.HTMLIFrameElement&&p instanceof window.HTMLIFrameElement)try{p=p.contentDocument.head}catch{p=null}g[h]=p}return g[h]}}(),n=[];function u(g){for(var h=-1,p=0;p<n.length;p++)if(n[p].identifier===g){h=p;break}return h}function l(g,h){for(var p={},T=[],w=0;w<g.length;w++){var R=g[w],W=h.base?R[0]+h.base:R[0],it=p[W]||0,dt="".concat(W," ").concat(it);p[W]=it+1;var Tt=u(dt),Rt={css:R[1],media:R[2],sourceMap:R[3]};Tt!==-1?(n[Tt].references++,n[Tt].updater(Rt)):n.push({identifier:dt,updater:H(Rt,h),references:1}),T.push(dt)}return T}function b(g){var h=document.createElement("style"),p=g.attributes||{};if(p.nonce===void 0){var T=o.nc;T&&(p.nonce=T)}if(Object.keys(p).forEach(function(R){h.setAttribute(R,p[R])}),typeof g.insert=="function")g.insert(h);else{var w=c(g.insert||"head");if(!w)throw new Error("Couldn't find a style target. This probably means that the value for the 'insert' parameter is invalid.");w.appendChild(h)}return h}var v,D=(v=[],function(g,h){return v[g]=h,v.filter(Boolean).join(`
`)});function K(g,h,p,T){var w=p?"":T.media?"@media ".concat(T.media," {").concat(T.css,"}"):T.css;if(g.styleSheet)g.styleSheet.cssText=D(h,w);else{var R=document.createTextNode(w),W=g.childNodes;W[h]&&g.removeChild(W[h]),W.length?g.insertBefore(R,W[h]):g.appendChild(R)}}function Z(g,h,p){var T=p.css,w=p.media,R=p.sourceMap;if(w?g.setAttribute("media",w):g.removeAttribute("media"),R&&typeof btoa<"u"&&(T+=`
/*# sourceMappingURL=data:application/json;base64,`.concat(btoa(unescape(encodeURIComponent(JSON.stringify(R))))," */")),g.styleSheet)g.styleSheet.cssText=T;else{for(;g.firstChild;)g.removeChild(g.firstChild);g.appendChild(document.createTextNode(T))}}var Q=null,L=0;function H(g,h){var p,T,w;if(h.singleton){var R=L++;p=Q||(Q=b(h)),T=K.bind(null,p,R,!1),w=K.bind(null,p,R,!0)}else p=b(h),T=Z.bind(null,p,h),w=function(){(function(W){if(W.parentNode===null)return!1;W.parentNode.removeChild(W)})(p)};return T(g),function(W){if(W){if(W.css===g.css&&W.media===g.media&&W.sourceMap===g.sourceMap)return;T(g=W)}else w()}}t.exports=function(g,h){(h=h||{}).singleton||typeof h.singleton=="boolean"||(h.singleton=s());var p=l(g=g||[],h);return function(T){if(T=T||[],Object.prototype.toString.call(T)==="[object Array]"){for(var w=0;w<p.length;w++){var R=u(p[w]);n[R].references--}for(var W=l(T,h),it=0;it<p.length;it++){var dt=u(p[it]);n[dt].references===0&&(n[dt].updater(),n.splice(dt,1))}p=W}}}},782:(t,e,o)=>{t.exports=o(237)("./src/core.js")},783:(t,e,o)=>{t.exports=o(237)("./src/engine.js")},311:(t,e,o)=>{t.exports=o(237)("./src/ui.js")},584:(t,e,o)=>{t.exports=o(237)("./src/utils.js")},602:(t,e,o)=>{t.exports=o(237)("./src/watchdog.js")},237:t=>{"use strict";t.exports=CKEditor5.dll}},E={};function a(t){var e=E[t];if(e!==void 0)return e.exports;var o=E[t]={id:t,exports:{}};return f[t](o,o.exports,a),o.exports}a.n=t=>{var e=t&&t.__esModule?()=>t.default:()=>t;return a.d(e,{a:e}),e},a.d=(t,e)=>{for(var o in e)a.o(e,o)&&!a.o(t,o)&&Object.defineProperty(t,o,{enumerable:!0,get:e[o]})},a.o=(t,e)=>Object.prototype.hasOwnProperty.call(t,e),a.r=t=>{typeof Symbol<"u"&&Symbol.toStringTag&&Object.defineProperty(t,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(t,"__esModule",{value:!0})},a.nc=void 0;var r={};(()=>{"use strict";a.r(r),a.d(r,{ClassicEditor:()=>Ft});var t=a(311),e=a(783),o=a(584);class i extends t.EditorUI{constructor(m,O){super(m),this.view=O,this._toolbarConfig=(0,t.normalizeToolbarConfig)(m.config.get("toolbar")),this._elementReplacer=new o.ElementReplacer,this.listenTo(m.editing.view,"scrollToTheSelection",this._handleScrollToTheSelectionWithStickyPanel.bind(this))}get element(){return this.view.element}init(m){const O=this.editor,B=this.view,M=O.editing.view,U=B.editable,X=M.document.getRoot();U.name=X.rootName,B.render();const Nt=U.element;this.setEditableElement(U.name,Nt),B.editable.bind("isFocused").to(this.focusTracker),M.attachDomRoot(Nt),m&&this._elementReplacer.replace(m,this.element),this._initPlaceholder(),this._initToolbar(),B.menuBarView&&(0,t._initMenuBar)(O,B.menuBarView),this._initDialogPluginIntegration(),this.fire("ready")}destroy(){super.destroy();const m=this.view,O=this.editor.editing.view;this._elementReplacer.restore(),O.detachDomRoot(m.editable.name),m.destroy()}_initToolbar(){const m=this.view;m.stickyPanel.bind("isActive").to(this.focusTracker,"isFocused"),m.stickyPanel.limiterElement=m.element,m.stickyPanel.bind("viewportTopOffset").to(this,"viewportOffset",({top:O})=>O||0),m.toolbar.fillFromConfig(this._toolbarConfig,this.componentFactory),this.addToolbar(m.toolbar)}_initPlaceholder(){const m=this.editor,O=m.editing.view,B=O.document.getRoot(),M=m.sourceElement;let U;const X=m.config.get("placeholder");X&&(U=typeof X=="string"?X:X[this.view.editable.name]),!U&&M&&M.tagName.toLowerCase()==="textarea"&&(U=M.getAttribute("placeholder")),U&&(B.placeholder=U),(0,e.enablePlaceholder)({view:O,element:B,isDirectHost:!1,keepOnFocus:!0})}_handleScrollToTheSelectionWithStickyPanel(m,O,B){const M=this.view.stickyPanel;if(M.isSticky){const U=new o.Rect(M.element).height;O.viewportOffset.top+=U}else{const U=()=>{this.editor.editing.view.scrollToTheSelection(B)};this.listenTo(M,"change:isSticky",U),setTimeout(()=>{this.stopListening(M,"change:isSticky",U)},20)}}_initDialogPluginIntegration(){if(!this.editor.plugins.has("Dialog"))return;const m=this.view.stickyPanel,O=this.editor.plugins.get("Dialog");O.on("show",()=>{const B=O.view;B.on("moveTo",(M,U)=>{if(!m.isSticky||B.wasMoved)return;const X=new o.Rect(m.contentPanelElement);U[1]<X.bottom+t.DialogView.defaultOffset&&(U[1]=X.bottom+t.DialogView.defaultOffset)},{priority:"high"})},{priority:"low"})}}var s=a(591),c=a.n(s),n=a(662),u={injectType:"singletonStyleTag",attributes:{"data-cke":!0},insert:"head",singleton:!0};c()(n.A,u),n.A.locals;class l extends t.BoxedEditorUIView{constructor(m,O,B={}){super(m),this.stickyPanel=new t.StickyPanelView(m),this.toolbar=new t.ToolbarView(m,{shouldGroupWhenFull:B.shouldToolbarGroupWhenFull}),B.useMenuBar&&(this.menuBarView=new t.MenuBarView(m)),this.editable=new t.InlineEditableUIView(m,O)}render(){super.render(),this.menuBarView?this.stickyPanel.content.addMany([this.menuBarView,this.toolbar]):this.stickyPanel.content.add(this.toolbar),this.top.add(this.stickyPanel),this.main.add(this.editable)}}var b=a(782),v=a(602);const D=function(S){return S!=null&&typeof S=="object"},K=typeof global=="object"&&global&&global.Object===Object&&global;var Z=typeof self=="object"&&self&&self.Object===Object&&self;const Q=(K||Z||Function("return this")()).Symbol;var L=Object.prototype,H=L.hasOwnProperty,g=L.toString,h=Q?Q.toStringTag:void 0;const p=function(S){var m=H.call(S,h),O=S[h];try{S[h]=void 0;var B=!0}catch{}var M=g.call(S);return B&&(m?S[h]=O:delete S[h]),M};var T=Object.prototype.toString;const w=function(S){return T.call(S)};var R=Q?Q.toStringTag:void 0;const W=function(S){return S==null?S===void 0?"[object Undefined]":"[object Null]":R&&R in Object(S)?p(S):w(S)},it=function(S,m){return function(O){return S(m(O))}}(Object.getPrototypeOf,Object);var dt=Function.prototype,Tt=Object.prototype,Rt=dt.toString,It=Tt.hasOwnProperty,Dt=Rt.call(Object);const Lt=function(S){if(!D(S)||W(S)!="[object Object]")return!1;var m=it(S);if(m===null)return!0;var O=It.call(m,"constructor")&&m.constructor;return typeof O=="function"&&O instanceof O&&Rt.call(O)==Dt},Mt=function(S){return D(S)&&S.nodeType===1&&!Lt(S)};class jt extends(0,b.ElementApiMixin)(b.Editor){constructor(m,O={}){if(!Wt(m)&&O.initialData!==void 0)throw new o.CKEditorError("editor-create-initial-data",null);super(O),this.config.define("menuBar.isVisible",!1),this.config.get("initialData")===void 0&&this.config.set("initialData",function(X){return Wt(X)?(0,o.getDataFromElement)(X):X}(m)),Wt(m)&&(this.sourceElement=m),this.model.document.createRoot();const B=!this.config.get("toolbar.shouldNotGroupWhenFull"),M=this.config.get("menuBar"),U=new l(this.locale,this.editing.view,{shouldToolbarGroupWhenFull:B,useMenuBar:M.isVisible});this.ui=new i(this,U),(0,b.attachToForm)(this)}destroy(){return this.sourceElement&&this.updateSourceElement(),this.ui.destroy(),super.destroy()}static create(m,O={}){return new Promise(B=>{const M=new this(m,O);B(M.initPlugins().then(()=>M.ui.init(Wt(m)?m:null)).then(()=>M.data.init(M.config.get("initialData"))).then(()=>M.fire("ready")).then(()=>M))})}}jt.Context=b.Context,jt.EditorWatchdog=v.EditorWatchdog,jt.ContextWatchdog=v.ContextWatchdog;const Ft=jt;function Wt(S){return Mt(S)}})(),(window.CKEditor5=window.CKEditor5||{}).editorClassic=r})();const rt=G(),Ct=(0,Y.default)("div")`${({editorStyles:f})=>f}`,st=({onChange:f,name:E,value:a,disabled:r,preset:t,maxLength:e})=>{const[o,i]=(0,J.useState)(!1),[s,c]=(0,J.useState)(!1),[n,u]=(0,J.useState)(null),[l,b]=(0,J.useState)(null),[v,D]=(0,J.useState)(!1),K=(0,J.useRef)(null),Z=()=>c(L=>!L),Q=L=>L>e?D(!0):D(!1);return(0,J.useEffect)(()=>{(async()=>{const{currentConfig:L,uploadPluginConfig:H}=await xt(t,Z);b(L),u(H)})()},[]),(0,A.jsxs)(A.Fragment,{children:[l&&(0,A.jsx)(rt,{}),(0,A.jsxs)(Ct,{editorStyles:l?.styles,children:[!l&&(0,A.jsx)(kt,{hasRadius:!0,background:"neutral100",children:(0,A.jsx)(et.a,{children:"Loading..."})}),l&&(0,A.jsx)($.CKEditor,{editor:window.CKEditor5.editorClassic.ClassicEditor,config:l?.editorConfig,disabled:r,data:a,onReady:L=>{if(l.editorConfig.WordCountPlugin){const H=L.plugins.get("WordCount");H.on("update",(h,p)=>Q(p.characters)),K.current?.appendChild(H.wordCountContainer)}L.plugins.has("ImageUploadEditing")&&L.plugins.get("ImageUploadEditing").on("uploadComplete",(H,{data:g,imageElement:h})=>L.model.change(p=>p.setAttribute("alt",g.alt,h))),i(L)},onChange:(L,H)=>{const g=H.getData();f({target:{name:E,value:g}})}}),l&&l.editorConfig.WordCountPlugin&&(0,A.jsx)(lt,{color:v?"danger500":"neutral400",ref:K,children:!o&&(0,A.jsx)(et.a,{small:!0,children:"Loading..."})}),n&&(0,A.jsx)(ot,{isOpen:s,onToggle:Z,editor:o,uploadConfig:n})]})]})};st.defaultProps={value:"",disabled:!1},st.propTypes={onChange:F().func.isRequired,name:F().string.isRequired,value:F().string,disabled:F().bool};const lt=(0,Y.default)(k.a)`
  display:flex;
  width: 100%;
